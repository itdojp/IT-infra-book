...
![図1-1: OSI参照モデルとTCP/IPモデルの比較]({{ '/assets/images/diagrams/chapter01/osi-tcpip-comparison.svg' | relative_url }})
...
![図1-2: カプセル化とデカプセル化のプロセス]({{ '/assets/images/diagrams/chapter01/encapsulation-decapsulation.svg' | relative_url }})
...
![図1-3: レイヤー間相互作用とパフォーマンス特性]({{ '/assets/images/diagrams/chapter01/layer-performance-characteristics.svg' | relative_url }})
